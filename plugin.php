...
Author: Ingrid
Version: 1.0.0
Author URI: http://www.ingridfeijt.be
*/

//add a bar after the opening body
add_action('wp_body_open', 'tb_head');

//display user or website
...
function tb_css() {
    echo '
    <style>
    h3.tb {color: #fff; margin: 0; padding: 30px; texte-align: center; background: orange}
    </style>';
}
